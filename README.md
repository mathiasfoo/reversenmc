The Simulink file "hill_analytical_optimise_compare.slx" is used for comparison of the Base Circuit between the Hill function obtained analytically and through optimisation.
